...
{%- block draw %}
        ...
        self.invokeFunction(row, "prevNote", text = "Prev", description = "get to the previous note", icon = "TRIA_LEFT")
        self.invokeFunction(row, "nextNote", text = "Next", description = "get to the next note", icon = "TRIA_RIGHT")
